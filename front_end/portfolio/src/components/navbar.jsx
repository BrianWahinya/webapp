...
class NavBar extends React.Component {
  state = {
    webversions: {
      current_version: {
        link: "https://www.brianwahinya.com",
        name: "Current Version",
      },
      maiden_version: {
        link: "https://www.brianwahinya.com/oldversion",
        name: "Maiden Version",
      },
    },
    defaultParams: {
      ...
      return (
        <li>
          <button
            ...
            key={id}
            id={id}
            onClick={() => this.projectLinkClick(id)}
          >
            {name} {emoji}
          </button>
        </li>
              ...
              <ul className="navbar-nav">
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu dropdown-menu-start">
                    <a
                      className="dropdown-item"
                      href={webversions.current_version.link}
                      target="_blank"
                      rel="noreferrer"
                    >
                      {webversions.current_version.name}
                    </a>
                    <a
                      className="dropdown-item"
                      href={webversions.maiden_version.link}
                      target="_blank"
                      rel="noreferrer"
                    >
                      {webversions.maiden_version.name}
                    </a>
                  </div>
                </li>
                <li className="nav-item dropdown">
